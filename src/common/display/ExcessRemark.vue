<template>
	...
	<div id="excess-remark-box">
		...
		<el-card class="box-card">
			...
			<el-form :model="excessAuditModel" ref="excessAuditModel"  label-width="120px"  size="mini" :inline="true">
				<el-row :gutter="5">
			      	<el-col :span="12">
						<el-form-item label="审核意见">
							<el-input v-model.number="excessAuditModel.handleOpinionVal" :disabled="true" ></el-input>
						</el-form-item>
					</el-col>
				</el-row>
				<el-row :gutter="5">
					<el-col :span="12">
						<el-form-item label="批核产品">
							<el-input v-model.number="excessAuditModel.productName" :disabled="true"></el-input>
						</el-form-item>
					</el-col>
				</el-row>
				<el-row :gutter="5">
					<el-col :span="24">
						<el-form-item label="批核金额" >
							<el-input v-model.number="excessAuditModel.approvedAmount" :disabled="true" style="width:160px;"></el-input>
						</el-form-item>
					</el-col>
				</el-row>
				<el-row :gutter="5">
					<el-col :span="24">
						<el-form-item label="处理备注" >
							<el-input v-model="excessAuditModel.inHandleOpinion" type="textarea" :disabled="true"  style="width:360px;"></el-input>
						</el-form-item>
					</el-col>
				</el-row>
...
<script>
	...
	export default {
		 ...
		 //   this.getFinalAuditInfo(applyId);
		    this.getExcessAuditInfo(applyId);
  		},
	  	methods: {
	  		...
	  		getExcessAuditInfo(applyId){
	  			console.log("applyId::::" + applyId)
	  			findById('/sys/excessaudit/finalinfo.do?applyId='+applyId)
			      .then(response => {
			         //console.info("^^^^^ :" + JSON.stringify(response));
			         //console.log(response.data)
			         this.excessAuditModel = response.data;
			    });
	  		},
	  		
	  		gotoListView(){
	      		this.$router.push({path:"/excessaudit"});
	      	}
	  	}
	}

			...
			<el-col :span="24">
				<div class="grid-content bg-purple-dark">
					<el-table  v-loading="loading"
						...
						<el-table-column prop="teamName" label="团队" min-width="100" fixed></el-table-column>
						<el-table-column prop="appoperName" label="客户经理" min-width="100" fixed></el-table-column>
...
<script>
	...
	export default {
		...
		methods: {
			getPager() {
				this.loading = true;
				fetchData('/sys/saleschart/findteam.do', this.listQuery).then(response => {
					this.loading = false;

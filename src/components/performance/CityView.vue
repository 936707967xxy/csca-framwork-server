			...
			<el-col :span="24">
				<div class="grid-content bg-purple-dark">
					<el-table  v-loading="loading"
						...
						<el-table-column type="index" min-width="35" fixed="left"></el-table-column>
						<el-table-column prop="areaName" label="城市名称" min-width="110" fixed="left"></el-table-column>
						<el-table-column prop="bitAreaName" label="大区" min-width="130"></el-table-column>
						<el-table-column prop="mob" label="大区MOB" min-width="120" :formatter="timeFormatter"></el-table-column>
						<el-table-column prop="record" label="放款数" min-width="100"></el-table-column>
						<el-table-column prop="loanAmount" label="放款额" min-width="120"></el-table-column>
						<el-table-column prop="conAmount" label="合同额" min-width="120"></el-table-column>
						...
						<el-table-column prop="approvedAmount" label="批核额" min-width="120"></el-table-column>
						<el-table-column prop="finalConAmount" label="批核合同额" min-width="120"></el-table-column>
...
<script>
	...
	export default {
		...
		methods: {
			getPager() {
				this.loading = true;
				fetchData('/sys/saleschart/findcity.do', this.listQuery).then(response => {

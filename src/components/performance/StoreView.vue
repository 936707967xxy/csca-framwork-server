			...
			<el-col :span="24">
				<div class="grid-content bg-purple-dark">
					<el-table   v-loading="loading"
						...
						<el-table-column prop="storeName" label="门店名称" min-width="180" fixed></el-table-column>
						<el-table-column prop="storeManage" label="门店经理" min-width="100"></el-table-column>
						<el-table-column prop="mob" label="门店MOB" :formatter="timeFormatter" min-width="100"></el-table-column>
...
<script>
	...
	export default {
		...
		methods: {
			getPager() {
				this.loading = true,
				fetchData('/sys/saleschart/findstore.do', this.listQuery).then(response => {
					this.loading = false,

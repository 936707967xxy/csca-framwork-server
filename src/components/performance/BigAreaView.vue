			...
			<el-col :span="24">
				<div class="grid-content bg-purple-dark">
					<el-table  v-loading="loading"
						...
						<el-table-column type="index" min-width="35" fixed></el-table-column>
						<el-table-column prop="bitAreaName" label="事业部名称" min-width="150" fixed></el-table-column>
						<el-table-column prop="record" label="放款数" min-width="80"></el-table-column>
						...
						<el-table-column prop="loanCount" label="进件数" min-width="120"></el-table-column>
...
<script>
	...
	export default {
		...
		methods: {
			getPager() {
				this.loading = true,
				fetchData('/sys/saleschart/bigarea.do', this.listQuery).then(response => {
					this.loading = false,

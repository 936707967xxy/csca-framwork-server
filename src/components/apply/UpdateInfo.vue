<template>
	<div id="update-info-box" class="create-box components-container apply-update-box">
					...
					<el-form ref="applyModel" :model="applyModel" :rules="rulesApplyModel" label-width="140px" size="mini" :inline="true">
							...
							<div class="text item firstBox">
								<span class="content-body">
										<el-form-item label="客户经理" prop="salesEmpDeptId">
											<el-select placeholder="请选择" v-model="applyModel.salesEmpDeptId" @change="changeDept"  :disabled="isAppFlag" style="width:130px;">
										...
										<el-form-item prop="salesEmpId">
											<el-select v-model="applyModel.salesEmpId" placeholder="请选择"  @change="changeSales" :disabled="isAppFlag" style="width:130px;">
												<el-option v-for="item in salesItem" :key="item.empId" :label="item.empName" :value="item.empId">
												</el-option>
											</el-select>
										</el-form-item>
										</span>
								...
								<span class="content-body">
										<el-form-item label="申请产品" prop="productTypeId">
											<el-select placeholder="请选择" v-model="applyModel.productTypeId" @change="changeProductType" style="width:130px;">
												<el-option v-for="item in productType" :key="item.prodId" :label="item.prodName" :value="item.prodId">
												</el-option>
											</el-select>
										</el-form-item>
										<el-form-item prop="productId">
											<el-select v-model="applyModel.productId" placeholder="请选择"  @change="changeProduct" style="width:130px;">
								...
								<span class="content-body">
										<el-form-item label="借款用途" prop="loanUse">
											<el-select placeholder="请选择" v-model="applyModel.loanUse" @change="loanUseChange" style="width:162px;" :disabled="isAppFlag">
												<el-option v-for="item in loanUseRadio" :key="item.value" :label="item.text" :value="item.value">
												</el-option>
											</el-select>
										</el-form-item>
										<el-form-item prop="loanUseText">
											<el-input class="explain" size="mini" v-model="applyModel.loanUseText" style="width:130px;" placeholder="其他值" :disabled="isAppFlag"></el-input>
										</el-form-item>
										</span>
								<span class="content-body">
										<el-form-item label="客户来源" prop="sources">
											<el-radio-group @change="sourcesChange" v-model="applyModel.sources" :disabled="isAppFlag">
												<el-radio v-for="item in sourcesRadio" :label="item.value" :key="item.value">{{item.text}}</el-radio>
											</el-radio-group>
										</el-form-item>
										<el-form-item prop="sourcesText">
											<el-input class="explain" size="mini" v-model="applyModel.sourcesText" style="width:130px;" placeholder="其他值" :disabled="isAppFlag"></el-input>
										</el-form-item>
										</span>
							</div>
						</el-card>
							...
							<div class="text item">
								<span class="content-body">
										<el-form-item label="姓名" prop="custName">
											<el-input v-model="applyModel.custName" :disabled="isAppFlag"></el-input>
										</el-form-item>
									</span>
								<span class="content-body">
								...
								<span class="content-body">
										<el-form-item label="证件号" prop="idNumber">
											<el-input v-model="applyModel.idNumber" placeholder="X字母大写" :disabled="isAppFlag"></el-input>
										</el-form-item>
								</span>
								<span class="content-body">
								...
								<span class="content-body">
										...
										<el-form-item prop="maritalStatusText">
											<el-input class="explain" size="mini" v-model="applyModel.maritalStatusText" style="min-width:130px;" placeholder="其他值"></el-input>
										</el-form-item>
									</span>
								<span class="content-body">
								...
								<span class="content-body">
										<el-form-item label="户口所在地" prop="rresidenceProvCode">
											<el-select v-model="applyModel.rresidenceProvCode" placeholder="请选择省" @change="rresidencePchange" style="width:150px;">
										...
										<el-form-item prop="rresidenceCityCode">
											<el-select v-model="applyModel.rresidenceCityCode" placeholder="请选择市" @change="rresidenceCchange" style="width:160px;">
										...
										<el-form-item prop="rresidenceAreaCode">
											<el-select v-model="applyModel.rresidenceAreaCode" placeholder="请选择区" @change="rresidenceAchange" style="width:120px;">
										...
										<el-form-item prop="rresidenceAddressDetail">
											<el-input v-model="applyModel.rresidenceAddressDetail" style="width:410px;" placeholder="请填写详细地址"></el-input>
										</el-form-item>
									</span>
								<span class="content-body">
										<el-form-item label="现居住地" prop="houseProvCode">
											<el-select v-model="applyModel.houseProvCode" placeholder="请选择省" @change="housePchange" style="width:150px;">
										...
										<el-form-item prop="houseCityCode">
											<el-select v-model="applyModel.houseCityCode" placeholder="请选择市" @change="houseCchange" style="width:160px;">
												<el-option v-for="item in houseC" :key="item.CITYID" :label="item.CITY" :value="item.CITYID">
												</el-option>
											</el-select>
										</el-form-item>
										<el-form-item prop="houseAreaCode">
											<el-select v-model="applyModel.houseAreaCode" placeholder="请选择区" @change="houseAchange" style="width:120px;">
												<el-option v-for="item in houseA" :key="item.AREAID" :label="item.AREA" :value="item.AREAID">
												</el-option>
											</el-select>
										</el-form-item>
										<el-form-item prop="houseAddressDetail">
											<el-input v-model="applyModel.houseAddressDetail" style="width:410px;" placeholder="请填写详细地址"></el-input>
										</el-form-item>
									</span>
								<span class="content-body">
										...
										<el-form-item prop="rentMonthlyPay">
											<el-input class="explain" size="mini" v-model="applyModel.rentMonthlyPay" style="width:120px;" placeholder="租金值"></el-input>
										</el-form-item>
									</span>
									<div>
								<span class="content-body">
								...
								<span class="content-body">
										...
										<el-form-item prop="validMailAddrTxt">
											<el-input class="explain" size="mini" v-model="applyModel.validMailAddrTxt" style="width:390px;" placeholder="其他值"></el-input>
										</el-form-item>
								</span>
							</div>
						</el-card>
						...
						<el-card class="box-card">
							<div slot="header" class="clearfix">
								<span style="font-weight: bold;">资产信息</span>
							</div>
							<div class="text item">
								<span class="content-body">
								...
								<span class="content-body">
										<el-form-item label="房产取得时间" prop="assetInfo.proBuyTime" :rules="proBuyTimeRule">
											<!--:rules="proBuyTimeRule"-->
											<el-date-picker @change="propertyTypeChangeUtil" v-model="applyModel.assetInfo.proBuyTime" type="date" placeholder="选择日期" style="width: 178px;" :editable="false">
											</el-date-picker>
										</el-form-item>
									</span>
								<span class="content-body">
										<el-form-item label="购买/建造总价" prop="assetInfo.proBuyPrice" :rules="proBuyPriceRule">
											<el-input @change="propertyTypeChangeUtil" v-model="applyModel.assetInfo.proBuyPrice" placeholder="元"></el-input>
										</el-form-item>
									</span>
								<span class="content-body">
										<el-form-item label="房产建筑面积" prop="assetInfo.gfa" :rules="gfaRule">
											<el-input @change="propertyTypeChangeUtil" v-model="applyModel.assetInfo.gfa" placeholder="平方米"></el-input>
										</el-form-item>
									</span>
								<span class="content-body">
										<el-form-item label="借款年限" prop="assetInfo.proLoanLife" :rules="proLoanLifeRule">
											<el-input @change="propertyTypeChangeUtil" v-model="applyModel.assetInfo.proLoanLife" placeholder="年"></el-input>
										</el-form-item>
									</span>
								<span class="content-body">
										<el-form-item label="月还款金额" prop="assetInfo.proMortgageMonthly" :rules="proMortgageMonthlyRule">
											<el-input @change="propertyTypeChangeUtil" v-model="applyModel.assetInfo.proMortgageMonthly" placeholder="元"></el-input>
										</el-form-item>
									</span>
								<span class="content-body">
										<el-form-item label="借款余额" prop="assetInfo.proLoans" :rules="proLoansRule">
											<el-input @change="propertyTypeChangeUtil" v-model="applyModel.assetInfo.proLoans" placeholder="元"></el-input>
										</el-form-item>
									</span>
								<span class="content-body">
										<el-form-item label="剩余期限" prop="assetInfo.proCreditPeriod" :rules="proCreditPeriodRule">
											<el-input @change="propertyTypeChangeUtil" v-model="applyModel.assetInfo.proCreditPeriod" placeholder="月"></el-input>
										</el-form-item>
								</span>
								<span class="content-body">
										<el-form-item label="房产地址" prop="assetInfo.isHomeAddress" :rules="isHomeAddressRule">
											<!--:rules="isHomeAddressRule"-->
											<el-radio-group @change="isHomeAddressChange" v-model="applyModel.assetInfo.isHomeAddress">
										...
										<el-form-item prop="assetInfo.propertyProvCode" :rules="addressRule">
											<el-select v-model="applyModel.assetInfo.propertyProvCode" placeholder="请选择" @change="propertyPchange" style="width:150px;">
										...
										<el-form-item prop="assetInfo.propertyCityCode" :rules="addressRule">
											<el-select v-model="applyModel.assetInfo.propertyCityCode" placeholder="请选择" @change="propertyCchange" style="width:160px;">
										...
										<el-form-item prop="assetInfo.propertyAreaCode" :rules="addressRule">
											<el-select v-model="applyModel.assetInfo.propertyAreaCode" placeholder="请选择" @change="propertyAchange" style="width:120px;">
										...
										<el-form-item prop="assetInfo.propertyAddressDetail" :rules="addressRuleDetail">
											<el-input size="mini" @change="propertyTypeChangeUtil" v-model="applyModel.assetInfo.propertyAddressDetail" style="width:220px;" placeholder="详细地址值"></el-input>
										</el-form-item>
								</span><br/>
								<span class="content-body">
								...
								<span class="content-body">
										<el-form-item label="购买价" prop="assetInfo.priceCar" class="purchasePrice" :rules="purchasePriceRule">
											<el-input v-model="applyModel.assetInfo.priceCar" @change="carHavaChangeUtil" placeholder="元"></el-input>
										</el-form-item>
									</span>
								<span class="content-body">
										<el-form-item label="车龄" prop="assetInfo.carAge" :rules="carAgeRule">
											<el-input v-model="applyModel.assetInfo.carAge" @change="carHavaChangeUtil" placeholder="年"></el-input>
										</el-form-item>
									</span>
								<span class="content-body">
										<el-form-item label="贷款发放日期" prop="assetInfo.carLoanDate" :rules="carLoanDateRule">
											<!--:rules="carLoanDateRule"-->
											<el-date-picker v-model="applyModel.assetInfo.carLoanDate" @change="carHavaChangeUtil" type="date" placeholder="选择日期" style="width: 178px;" :editable="false">
											</el-date-picker>
										</el-form-item>
									</span>
								<span class="content-body">
										<el-form-item label="按揭月供" prop="assetInfo.carMortgageMonthly" :rules="carMortgageMonthlyRule">
											<el-input @change="carHavaChangeUtil" v-model="applyModel.assetInfo.carMortgageMonthly" placeholder="元"></el-input>
										</el-form-item>
									</span>
								<span class="content-body">
										<el-form-item label="贷款总额" prop="assetInfo.carLoanCeiling" :rules="carLoanCeilingRule">
											<el-input @change="carHavaChangeUtil" v-model="applyModel.assetInfo.carLoanCeiling" placeholder="元"></el-input>
										</el-form-item>
									</span>
								<span class="content-body">
										<el-form-item label="借款余额" prop="assetInfo.carBanlanceVal" :rules="carBanlanceValRule">
											<el-input @change="carHavaChangeUtil" v-model="applyModel.assetInfo.carBanlanceVal" placeholder="元"></el-input>
										</el-form-item>
									</span>
								<span class="content-body">
										<el-form-item label="剩余期限" prop="assetInfo.carPeriodVal" :rules="carPeriodValRule">
											<el-input @change="carHavaChangeUtil" v-model="applyModel.assetInfo.carPeriodVal" placeholder="月"></el-input>
										</el-form-item>
									</span>
							</div>
						</el-card>
						...
						<el-card class="box-card">
							<div slot="header" class="clearfix">
								<span style="font-weight: bold;">职业信息</span>
							</div>
							<div class="text item">
								<span class="content-body">
										<el-form-item label="所属行业" prop="userOccupationalInfo.industryIn" :rules="{required: true, message: '请选择所属行业', trigger: 'change' }">
											<el-select v-model="applyModel.userOccupationalInfo.industryIn" placeholder="请选择" style="min-width:150px;" @change="changeIndustryIn">
								...
								<span class="content-body">
										<el-form-item label="邮编" prop="userOccupationalInfo.companyZipCode" :rules="{required: true, message: '邮编格式有误', trigger: 'blur',pattern:'^[1-9]\\d{5}$',max:6}">
								...
								<span class="content-body">
										<el-form-item label="单位地址" prop="userOccupationalInfo.companyProvCode" :rules="{required: true, message: '请选择', trigger: 'change',}">
											<el-select v-model="applyModel.userOccupationalInfo.companyProvCode" placeholder="请选择" @change="companyPchange" style="width:150px;">
										...
										<el-form-item prop="userOccupationalInfo.companyCityCode" :rules="{required: true, message: '请选择', trigger: 'change',}">
											<el-select v-model="applyModel.userOccupationalInfo.companyCityCode" placeholder="请选择" @change="companyCchange" style="width:160px;">
										...
										<el-form-item prop="userOccupationalInfo.companyAreaCode" :rules="{required: true, message: '请选择', trigger: 'change',}">
											<el-select v-model="applyModel.userOccupationalInfo.companyAreaCode" placeholder="请选择" @change="companyAchange" style="width:120px;">
										...
										<el-form-item prop="userOccupationalInfo.companyAddressDetail" :rules="{required: true, message: '请填写详细地址', trigger: 'blur',max:50}">
											<el-input v-model="applyModel.userOccupationalInfo.companyAddressDetail" style="width:410px;" placeholder="详细地址值"></el-input>
										</el-form-item>
								...
								<span class="content-body">
										...
										<el-form-item prop="userOccupationalInfo.companyKindTxt" :rules="companyKindTxtRule">
											<el-input class="explain" size="mini" v-model="applyModel.userOccupationalInfo.companyKindTxt" style="width:130px;" placeholder="其他值"></el-input>
											</el-radio-group>
										</el-form-item>
								</span>
								<span class="content-body">
										...
										<el-form-item prop="userOccupationalInfo.positionTxt" :rules="positionTxtRule">
											<el-input class="explain" size="mini" v-model="applyModel.userOccupationalInfo.positionTxt" style="min-width:120px;" placeholder="其他值"></el-input>
										</el-form-item>
								</span>
								<br/>
								<span class="content-body" style="margin-right:198px;">
										...
										<el-form-item prop="userOccupationalInfo.privateTypeText" :rules="privateTypeTextRule">
											<el-input class="explain" size="mini" @change="privateTypeChangeUtil" v-model="applyModel.userOccupationalInfo.privateTypeText" style="width:130px;" placeholder="其他值"></el-input>
										</el-form-item>
									</span>
								<span class="content-body">
										<el-form-item label="员工人数" prop="userOccupationalInfo.employeesNum" class='memberCount' :rules="employeesNumRule">
											<el-input v-model="applyModel.userOccupationalInfo.employeesNum" @change="privateTypeChangeUtil"></el-input>
										</el-form-item>
									</span>
								<span class="content-body">
										<el-form-item label="经营场所" prop="userOccupationalInfo.premises" :rules="premisesRule">
											<!--:rules="premisesRule"-->
											<el-radio-group @change="premisesChange" v-model="applyModel.userOccupationalInfo.premises">
												<el-radio v-for="item in premisesRadio" :label="item.value" :key="item.value">{{item.text}}</el-radio>
											</el-radio-group>
										</el-form-item>
									</span>
								<span class="content-body">
										<el-form-item label="成立时间" prop="userOccupationalInfo.companyRegtime" :rules="companyRegtimeRule">
											<!--:rules="companyRegtimeRule"-->
											<el-date-picker @change="privateTypeChangeUtil" v-model="applyModel.userOccupationalInfo.companyRegtime" type="date" placeholder="选择日期" style="width: 178px;" :editable="false">
											</el-date-picker>
										</el-form-item>
									</span>
								<span class="content-body">
										<el-form-item label="股份占比" prop="userOccupationalInfo.percentageShares" :rules="percentageSharesRule">
											<el-input @change="privateTypeChangeUtil" v-model="applyModel.userOccupationalInfo.percentageShares" placeholder="%"></el-input>
										</el-form-item>
								</span>
							</div>
						</el-card>
						...
						<el-card class="box-card">
							...
							<div class="text item">
								...
								<el-row style="padding-left:6px;font-size:14px;font-weight: normal;">
									<el-col :span="1">
								...
								<el-row style="margin-top:6px;" v-for="(contact, index) in applyModel.userContacts" :key="index">
									<el-col :span="1">
										<div class="grid-content bg-purple" style="font-weight: normal;">{{index+1}}</div>
									</el-col>
									<el-col :span="3">
										<div class="grid-content bg-purple">
						...
						<el-form-item style="margin-left:20px;">
							<el-button type="primary" @click="onSubmit('applyModel')" v-loading.fullscreen.lock="fullscreenLoading">确定修改</el-button>
...
<script>
	...
	export default {
			...
			var checkIdNumber = (rule, value, callback) => {
				if(!value) {
					...
					if(reg18.test(value) || reg15.test(value)) {
						var url = "sys/blackinfo/findbyidnumberupdate.do?idnumber=" + value + "&applyId=" + this.applyModel.applyId;
		...
		created() {
			...
			var url = "/sys/applymodel/selectapplybyid.do?applyId=" + this.$route.params.applyId;
			findById(url).then(response => {
				////console.log(response.data.userContacts);
				this.applyModel = response.data;
				if(this.applyModel.isApp != null && this.applyModel.isApp == 1 || this.applyModel.isApp == 2) {
					this.isAppFlag = true;
					this.loanUseText = {};
				}
				...
				findById('/sys/producttype/findtypeexcept.do?except=ebd0eaf7369649bda23bdd6a75015766') //初始化产品类型
					.then(response => {
						//console.info("^^^^^ :" + JSON.stringify(response));
				...
				if(this.applyModel.salesEmpDeptId != null) {
					findById('/sys/applymodel/selectempbydepid.do?depId=' + this.applyModel.salesEmpDeptId) //初始化销售团队
						.then(response => {
							//console.info("^^^^^ :" + JSON.stringify(response));
							this.salesItem = response.data;
						});
				}
				if(this.applyModel.rresidenceProvCode != null) {
					findById('/sys/applymodel/findcitiebypro.do?provinceId=' + this.applyModel.rresidenceProvCode)
						.then(response => {
							this.rresidenceC = response.data;
						});
				}
				if(this.applyModel.rresidenceCityCode != null) {
					findById('/sys/applymodel/findareabycity.do?cityId=' + this.applyModel.rresidenceCityCode)
						.then(response => {
							this.rresidenceA = response.data;
						});
				}
				if(this.applyModel.houseProvCode != null) {
					findById('/sys/applymodel/findcitiebypro.do?provinceId=' + this.applyModel.houseProvCode)
						.then(response => {
							this.houseC = response.data;
						});
				}
				if(this.applyModel.houseCityCode != null) {
					findById('/sys/applymodel/findareabycity.do?cityId=' + this.applyModel.houseCityCode)
						.then(response => {
							this.houseA = response.data;
						});
				}
				if(this.applyModel.assetInfo.propertyProvCode != null) {
					findById('/sys/applymodel/findcitiebypro.do?provinceId=' + this.applyModel.assetInfo.propertyProvCode)
						.then(response => {
				...
				if(this.applyModel.assetInfo.propertyCityCode != null) {
					findById('/sys/applymodel/findareabycity.do?cityId=' + this.applyModel.assetInfo.propertyCityCode)
						.then(response => {
							this.propertyA = response.data;
						});
				}
				if(this.applyModel.userOccupationalInfo.companyProvCode != null) {
					findById('/sys/applymodel/findcitiebypro.do?provinceId=' + this.applyModel.userOccupationalInfo.companyProvCode)
						.then(response => {
							this.companyC = response.data;
						});
				}
				if(this.applyModel.userOccupationalInfo.companyCityCode != null) {
					findById('/sys/applymodel/findareabycity.do?cityId=' + this.applyModel.userOccupationalInfo.companyCityCode)
						.then(response => {
							this.companyA = response.data;
						});
				}
				if(this.applyModel.productTypeId != null) {
					findById('/sys/product/querybytype.do?prodTypeId=' + this.applyModel.productTypeId)
						.then(response => {
							this.product = response.data;
							this.applyPeriod = response.data.sterm;
						});
				}
		...
		methods: {
			...
			changeSales(value) {
				for(var i = 0; i < this.salesItem.length; i++) {
					if(value == this.salesItem[i].empId) {
						//给部门名称赋值
						this.applyModel.salesEmpName = this.salesItem[i].empName;
					}
				}
			},
			...
			idNumberBlack() {
				...
				var url = "sys/blackinfo/findbyidnumberupdate.do?idnumber=" + idNumber + "&applyId=" + this.applyModel.applyId;
				findById(url).then(response => {
					var result = response.data;
					if(result.success) {
			...
			carHavaChange(value) {
				...
				if(value == 1) { //无车辆
					...
					this.carMortgageMonthlyRule = {
						message: '请填写数字格式',
						trigger: 'blur',
						pattern: '^[0-9]+(.[0-9]{2})?$',
						max: 20
					}
					this.carLoanCeilingRule = {
						message: '请填写数字格式',
						trigger: 'blur',
						pattern: '^[0-9]+(.[0-9]{2})?$',
						max: 25
					}
					this.carBanlanceValRule = {
						message: '请填写数字格式',
						trigger: 'blur',
						pattern: '^[0-9]+(.[0-9]{2})?$',
						max: 25
					}
					this.carPeriodValRule = {
						message: '请填写数字格式',
						trigger: 'blur',
						pattern: '^[0-9]+(.[0-9]{2})?$',
						max: 3
					...
					this.applyModel.assetInfo.carLoanDate = "",
						this.applyModel.assetInfo.carMortgageMonthly = "",
						this.applyModel.assetInfo.carLoanCeiling = "",
						this.applyModel.assetInfo.carBanlanceVal = "",
						this.applyModel.assetInfo.carPeriodVal = ""
			...
			onSubmit(formName) {
				...
				var url = "/sys/applymodel/updateapply.do";

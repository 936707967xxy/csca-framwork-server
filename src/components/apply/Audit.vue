<template>
	<div class="components-container components-container2" id="components-container">
			...
			<template slot="paneR">
				<div class="right-box" ref="paneRbox">
					...
					<el-tabs v-model="activeName" type="card" style="padding-left: 10px;">
						...
						<el-tab-pane label="提交申请" name="six">
							<div class="right-container">
								<au-apply :apply-id="applyId"></au-apply>
							</div>
						</el-tab-pane>
					</el-tabs>
				</div>
...
<script>
	...
	import AuApply from '@/components/apply/ApplyService.vue'
...
<style>
	@media only screen and (max-width:1366px) {
		...
		.components-container2 .vertical {

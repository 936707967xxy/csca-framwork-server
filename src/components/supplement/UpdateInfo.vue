<template>
	<div id="update-info-box" class="create-box components-container-box">

					<el-card class="box-card">
						<div slot="header" class="clearfix">
							<span style="font-weight: bold;">退回意见</span>
						</div>
						<el-table :data="tableData" border style="width:100%; font-weight:normal;" cell-class-name="cell-class">
					...
					<el-form ref="applyModel" :model="applyModel" :rules="rulesApplyModel" label-width="140px" size="mini" :inline="true">
							...
							<div class="text item firstBox">
								<span class="content-body">
										<el-form-item label="客户经理" prop="salesEmpDeptId">
											<el-select placeholder="请选择" v-model="applyModel.salesEmpDeptId" @change="changeDept" style="width:130px;" :disabled="true">
												<el-option v-for="item in department" :key="item.storeId" :label="item.storeName" :value="item.storeId">
												</el-option>
											</el-select>
										</el-form-item>
										<el-form-item prop="salesEmpId">
											<el-select v-model="applyModel.salesEmpId" placeholder="请选择" style="width:130px;" @change="changeSales" :disabled="true">
								...
								<span class="content-body">
										<el-form-item label="申请产品" prop="productTypeId">
											<el-select placeholder="请选择" v-model="applyModel.productTypeId" @change="changeProductType" style="width:130px;" :disabled="true">
												<el-option v-for="item in productType" :key="item.prodId" :label="item.prodName" :value="item.prodId">
												</el-option>
											</el-select>
										</el-form-item>
										<el-form-item prop="productId">
											<el-select v-model="applyModel.productId" placeholder="请选择" style="width:130px;" @change="changeProduct" :disabled="true">
								...
								<span class="content-body">
										<el-form-item label="借款用途" prop="loanUse">
											<el-select placeholder="请选择" v-model="applyModel.loanUse" @change="loanUseChange" style="width:178px;" :disabled="true">
												<el-option v-for="item in loanUseRadio" :key="item.value" :label="item.text" :value="item.value">
												</el-option>
											</el-select>
										</el-form-item>
										<el-form-item prop="loanUseText">
											<el-input class="explain" size="mini" v-model="applyModel.loanUseText" style="min-width:130px;" placeholder="其他值" :disabled="true"></el-input>
										</el-form-item>
										</span>
								<span class="content-body">
										<el-form-item label="客户来源" prop="sources">
											<el-radio-group @change="sourcesChange" v-model="applyModel.sources" :disabled="true">
												<el-radio v-for="item in sourcesRadio" :label="item.value" :key="item.value">{{item.text}}</el-radio>
											</el-radio-group>
										</el-form-item>
										<el-form-item prop="sourcesText">
											<el-input class="explain" size="mini" v-model="applyModel.sourcesText" style="min-width:130px;" placeholder="其他值" :disabled="true"></el-input>
										</el-form-item>
								</span>
							</div>
						</el-card>
							...
							<div class="text item">
								...
								<span class="content-body">
										...
										<el-form-item prop="maritalStatusText">
											<el-input class="explain" size="mini" v-model="applyModel.maritalStatusText" style="width:130px;" placeholder="其他值"></el-input>
										</el-form-item>
										</span>
								<span class="content-body">
								...
								<span class="content-body">
										...
										<el-form-item prop="rresidenceAddressDetail">
											<el-input v-model="applyModel.rresidenceAddressDetail" style="width:400px;" placeholder="请填写详细地址"></el-input>
										</el-form-item>
										</span>
								<span class="content-body">
										...
										<el-form-item prop="houseAddressDetail">
											<el-input v-model="applyModel.houseAddressDetail" style="width:400px;" placeholder="请填写详细地址"></el-input>
										</el-form-item>
										</span>
								<span class="content-body">
										...
										<el-form-item prop="rentMonthlyPay">
											<el-input class="explain" size="mini" v-model="applyModel.rentMonthlyPay" style="width:130px;" placeholder="租金值"></el-input>
										</el-form-item>
										</span>
								<span class="content-body">
							...
							<div class="text item">
								...
								<span class="content-body">
										...
										<el-form-item prop="assetInfo.propertyProvCode" :rules="addressRule">
											<el-select v-model="applyModel.assetInfo.propertyProvCode" placeholder="请选择" @change="propertyPchange" style="width:130px;">
										...
										<el-form-item prop="assetInfo.propertyCityCode" :rules="addressRule">
											<el-select v-model="applyModel.assetInfo.propertyCityCode" placeholder="请选择" @change="propertyCchange" style="width:130px;">
										...
										<el-form-item prop="assetInfo.propertyAreaCode" :rules="addressRule">
											<el-select v-model="applyModel.assetInfo.propertyAreaCode" placeholder="请选择" @change="propertyAchange" style="width:130px;">
										...
										<el-form-item prop="assetInfo.propertyAddressDetail" :rules="addressRuleDetail">
											<el-input size="mini" @change="propertyTypeChangeUtil" v-model="applyModel.assetInfo.propertyAddressDetail" style="width:270px;" placeholder="详细地址值"></el-input>
										</el-form-item>
										</span>
								<span class="content-body">
							...
							<div class="text item">
								...
								<span class="content-body">
										...
										<el-form-item prop="userOccupationalInfo.companyAddressDetail" :rules="{required: true, message: '请填写详细地址', trigger: 'blur',max:50}">
											<el-input v-model="applyModel.userOccupationalInfo.companyAddressDetail" style="width:390px;" placeholder="详细地址值"></el-input>
										</el-form-item>
								...
								<span class="content-body">
										...
										<el-form-item prop="userOccupationalInfo.privateTypeText" :rules="privateTypeTextRule">
											<el-input class="explain" size="mini" @change="privateTypeChangeUtil" v-model="applyModel.userOccupationalInfo.privateTypeText" style="min-width:120px;" placeholder="其他值"></el-input>
										</el-form-item>
										</span>
								<span class="content-body">
						...
						<el-card class="box-card">
							...
							<div class="text item">
								...
								<el-row style="padding-left:5px;font-size:14px;font-weight: normal;">
									<el-col :span="1">
...
<script>
	...
	export default {
		...
		created() {
			this.applyModel.applyId = this.$route.params.applyId;
			var url = "/sys/supplement/beforesubmit.do?applyId=" + this.applyModel.applyId;
			findById(url).then(response => {
				this.tableData = response.data;
				//console.log(JSON.stringify(response.data))
			})
			var url = "/sys/supplement/selectapplybyid.do?applyId=" + this.applyModel.applyId;
			findById(url).then(response => {
		...
		methods: {
			...
			onSubmit(formName) {
				...
				var url = "/sys/supplement/updateapply.do";

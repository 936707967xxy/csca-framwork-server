  ...
  <div id="normal-type-box" class="wrap-box money-daihou-style">
		<div class="crumbs hander-class">
			<el-breadcrumb separator="/" separator-class="el-icon-arrow-right">
				...
				<el-breadcrumb-item>减免二级审批</el-breadcrumb-item>
			</el-breadcrumb>
		</div>
...
import overdueApplyOne from "./overdueApplyOneDetails2.vue";
import overdueApplyMore from "./overdueApplyMoreDetails2.vue";
...
export default {
  ...
  methods: {
    getPager() {
      fetchData("/after/subapply/examinelist.do",this.listQuery).then(response => {

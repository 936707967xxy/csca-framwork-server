        ...
        <el-tab-pane label="单月减免申请单" name="overdueSingle">
          ...
          <el-form :model="overdueApplyForm2" ref="overdueApplyForm2" label-position="right" label-width="120px" size="small">
            ...
            <fieldset class="overdue-box">
              ...
              <el-row>
                <el-col :span="20">
                  <el-form-item  label="否决备注:" prop="approveDesc">
            ...
            <div class="dialog-footer-box">
              ...
              <el-button type="danger" @click="onSubmit('overdueApplyForm2')" size="mini">一键减免否决</el-button>
            </div>
        </el-tab-pane>
  ...
  methods: {
    ...
    onSubmit(formName) {
      ...
      this.$refs[formName].validate(valid => {
        if (valid) {
          this.$confirm("是否一键否决?", "提示", {
            confirmButtonText: "确定",
            cancelButtonText: "取消",
            type: "warning"
          })
            .then(() => {
              fetchData("/after/subapply/votedown.do",data).then(
                response => {

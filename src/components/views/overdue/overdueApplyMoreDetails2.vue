           ...
           <fieldset class="overdue-box">
              ...
              <el-row>
                <el-col :span="10">
                  ...
                  <el-input v-model="apporoveModel.approveOpinion1=='1'?'拒绝':'同意'" readonly></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="20">
                  <el-form-item label="审批备注:" prop="approveDesc1">
                      <el-input v-model="apporoveModel.approveDesc1" type='textarea' readonly></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
            </fieldset>
  ...
  methods:{
    ...
    getData() {
      ...
      fetchData("/after/flow/apply.do", data1).then(response => {
        ...
        this.apporoveModel.approveDesc1 = response.data[1].approveDesc;
        this.apporoveModel.approveOpinion1 = response.data[1].approveOpinion;
      });
    },
     tabClick(tab) {
      ...
      this.$refs[formName].validate(valid => {
        if (valid) {
          this.$confirm("此操作将批准减免申请, 是否继续?", "提示", {
            ...
            .then(() => {
              fetchData("/after/subapply/saveSubapply2.do",data).then(
                response => {

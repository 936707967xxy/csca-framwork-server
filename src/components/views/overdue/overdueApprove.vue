  ...
  <div id="normal-type-box" class="wrap-box money-daihou-style">
		<div class="crumbs hander-class">
			<el-breadcrumb separator="/" separator-class="el-icon-arrow-right">
				...
				<el-breadcrumb-item>减免一级审批</el-breadcrumb-item>
			</el-breadcrumb>
		</div>
        ...
        <el-row>
          <el-col class="form-r-btn">
            <el-form-item>
              <el-button type="warning" @click="applyDialog(typeFlag)" size="small">减免审批</el-button>
...
import overdueApplyOne from "./overdueApplyOneDetails.vue";
import overdueApplyMore from "./overdueApplyMoreDetails.vue";
...
export default {
  ...
  methods: {
    getPager() {
      fetchData("/after/subapply/examinelist2.do",this.listQuery).then(response => {

  ...
  <div id="normal-type-box" class="wrap-box money-daihou-style">
        ...
        <el-row>
          <el-col class="form-r-btn">
            <el-form-item>
              <el-button type="warning" @click="applyDialog" size="small">审批</el-button>
...
import messageUpdate from  "./msgUpdateDetails.vue";
...
export default {
  ...
  methods: {
    getPager() {
      fetchData("/after/messageupdate/examinelist2.do",this.listQuery).then(response => {

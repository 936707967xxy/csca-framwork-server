  ...
  <div id="normal-type-box" class="wrap-box money-daihou-style">
		<div class="crumbs hander-class">
			<el-breadcrumb separator="/" separator-class="el-icon-arrow-right">
				...
				<el-breadcrumb-item>信息变更二级审批</el-breadcrumb-item>
			</el-breadcrumb>
		</div>
...
import messageUpdate from  "./msgUpdateDetails2.vue";
...
export default {
  ...
  methods: {
    getPager() {
      fetchData("/after/messageupdate/examinelist.do",this.listQuery).then(response => {

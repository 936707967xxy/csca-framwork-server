<!--
	Created by yangfei on 2018/04/25.
    信息变更申请
-->
<template>
  <div>
              ...
              <el-row>
                <el-col :span="10">
                    <el-form-item label="审批意见:" prop="approveOpinion1">
                      <el-input v-model="applyModel1.approveOpinion1=='1'?'拒绝':'同意'" readonly></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="20">
                  <el-form-item  label="审批备注:" prop="applicationDesc1">
                      <el-input v-model="applyModel1.applicationDesc1" type='textarea' readonly></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
            </fieldset>
            <fieldset style="border-color: #fff;">
              <legend style="color: #409EFF;">二级审批:</legend>
              <el-row>
                <el-col :span="10">
  ...
  data() {
    return {
      ...
      applyModel1:{
        ...
        applicationDesc1:"",//一级审批备注
        approveOpinion1:"",//一级审批意见
      },
      rules: {
  ...
  methods: {
    ...
    getData() {
      ...
      fetchData("/after/flow/apply.do", data).then(response => {
        ...
        this.applyModel1.applicationDesc1 = response.data[1].approveDesc;
        this.applyModel1.approveOpinion1 = response.data[1].approveOpinion;
      });
    },
    tabClick(tab) {
    ...
    onSubmit() {
      ...
      fetchData("/after/messageupdate/changeinfoupdate2.do", data).then(
        response => {

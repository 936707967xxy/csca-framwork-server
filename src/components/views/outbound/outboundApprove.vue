<!--
	Created by yangfei on 2018/5/03.
    外访审批
-->
<template>
  <div id="normal-type-box" class="wrap-box money-daihou-style">
		<div class="crumbs hander-class">
			<el-breadcrumb separator="/" separator-class="el-icon-arrow-right">
				...
				<el-breadcrumb-item>外访审批</el-breadcrumb-item>
			</el-breadcrumb>
		</div>
...
import outboundApply from "./outboundApplyDetails.vue";
...
export default {
  ...
  methods: {
    getPager() {
      fetchData("/after/outbound/examinelist.do",this.listQuery).then(response => {

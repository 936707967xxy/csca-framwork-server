...
<template>
     <el-dialog :title="titleType" :visible.sync="dialogDetailForm" width="80%" center :show-close='false'>
      ...
      <el-form :model="leaveApplyForm" ref="leaveApplyForm" label-position="right" :rules="rule" size="small" label-width="120px">
        <div class="fieldset-box">
          <legend>留案申请:</legend>
          <el-row>
            <el-col :span="20">
              <el-form-item label="备注:" prop="applicationDesc">
                <el-input v-model="leaveApplyForm.applicationDesc" type='textarea' readonly></el-input>
              </el-form-item>
            </el-col>
          </el-row>
        </div>
        <div class="fieldset-box">
          ...
          <el-row>
            <el-col :span="10">
              ...
              <el-input v-model="leaveApplyForm.approveOpinion1=='1'?'拒绝':'同意'" readonly></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="20">
              <el-form-item label="审批备注:" prop="approveDesc1">
                  <el-input v-model="leaveApplyForm.approveDesc1" type='textarea' readonly></el-input>
              </el-form-item>
            </el-col>
          </el-row>
        </div>
          ...
          <el-row>
            <el-col :span="10">
                <el-form-item label="审批意见:" prop="approveOpinion">
                  <el-select v-model="leaveApplyForm.approveOpinion" placeholder="请选择" >
            ...
            <el-col :span="20">
              <el-form-item  label="审批备注:" prop="approveDesc">
                  <el-input v-model="leaveApplyForm.approveDesc" type='textarea'></el-input>
              </el-form-item>
            </el-col>
          </el-row>
        </div>
  ...
  methods: {
    ...
    getData() {
      ...
      fetchData("/after/flow/apply.do", data1).then(response => {
        this.leaveApplyForm.applicationDesc = response.data[0].approveDesc;
        this.leaveApplyForm.approveDesc1 = response.data[1].approveDesc;
        this.leaveApplyForm.approveOpinion1 = response.data[1].approveOpinion;
      });

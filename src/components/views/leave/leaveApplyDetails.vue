...
<template>
     <el-dialog :title="titleType" :visible.sync="dialogDetailForm" width="80%" center :show-close='false'>
      ...
      <el-form :model="leaveApplyForm" ref="leaveApplyForm" label-position="right" :rules="rule" size="small">
        <div class="fieldset-box">
          <legend>留案申请:</legend>
          <el-row>
            <el-col :span="20">
              <el-form-item label="备注:" prop="applicationDesc" label-width="120px">
        ...
        <div class="fieldset-box">
          ...
          <el-row>
            <el-col :span="10">
                <el-form-item label="审批意见:" prop="approveOpinion" label-width="120px">
            ...
            <el-col :span="20">
              <el-form-item  label="审批备注:" prop="approveDesc" label-width="120px">
  ...
  methods: {
    ...
    onSubmit(formName) {
      ...
      this.$confirm("此操作将提交留案申请, 是否继续?", "提示", {
        ...
        .then(() => {
          fetchData("/after/leaveapply/leaveapply1.do",data).then(
            response => {

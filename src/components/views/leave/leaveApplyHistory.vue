  ...
  <div id="normal-type-box" class="wrap-box money-daihou-style">
		<div class="crumbs hander-class">
			<el-breadcrumb separator="/" separator-class="el-icon-arrow-right">
				...
				<el-breadcrumb-item>留案申请记录</el-breadcrumb-item>
			</el-breadcrumb>
		</div>
    ...
    <el-table v-loading="loading" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading" :data="tableData"
        ...
        <el-table-column prop="updateDate" label="修改日期" min-width="170" align="center"></el-table-column>
    </el-table>
    <!-- 分页 -->
...
import leaveApply from "./leaveApplyHistoryDetails.vue";
...
export default {
  ...
  methods: {
    getPager() {
      fetchData("/after/leaveapply/leaveapplyHistory.do",this.listQuery).then(response => {

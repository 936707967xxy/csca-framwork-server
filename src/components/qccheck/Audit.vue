<template>
	<div class="components-container quality-testing" id="components-container">
		<el-select v-model="imgType" placeholder="请选择影像类型" style="margin-bottom:10px;" size="mini" @change="changeImgType">
...
<script>
	...
	import QcRemark from '@/components/qccheck/QcRemark.vue'
	import {
		findById,
		queryPostJson
